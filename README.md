...
This mod will allows you to use your bushcrafting skill to craft bandages from OAAB_Data and the effect varies depending on your character's Survival skill. 

The mod does requires OAAB_Data, The Crafting Framework, Skill Module, and Ashfall. So install them if you haven't already.
